// lib/screens/login/views/admin_auth_screen.dart
...
class _AdminAuthScreenState extends State<AdminAuthScreen> {
  ...
  final _pinController = TextEditingController(); // Changed from email/password controller
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Admin Login")), // Title updated
      body: SafeArea(
        child: Padding(
            ...
            child: SingleChildScrollView(
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    Text("Admin Access", style: Theme.of(context).textTheme.headlineSmall), // Text updated
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: "4-Digit PIN", // Label updated
